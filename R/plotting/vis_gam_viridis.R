vis.gam.viridis <- function (x, view = NULL, cond = list(), n.grid = 30, too.far = 0, 
    ...
    plot.type = "persp", zlim = NULL, nCol = 50, ...) 
{
    ...
    if (se <= 0) {
        ...
        if (color == "heat") {
            ...
            pal <- viridis_pal()(nCol)
            con.col <- 2
        }	
        else if (color == "plasma") {
            pal <- viridis_pal(option="plasma")(nCol)
            con.col <- 2
        }		
        else if (color == "magma") {
            pal <- viridis_pal(option="magma")(nCol)
            con.col <- 2
        }
        else if (color == "inferno") {
            pal <- viridis_pal(option="inferno")(nCol)
            con.col <- 2
        }		
